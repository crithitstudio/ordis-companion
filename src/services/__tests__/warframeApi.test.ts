...
const mockWorldStateResponse = {
  ...
  cetusCycle: {
    isDay: true,
    timeLeft: "45m",
    expiry: "2024-01-01T12:45:00.000Z",
  },
  vallisCycle: {
    isWarm: false,
    timeLeft: "15m",
    expiry: "2024-01-01T12:15:00.000Z",
  },
  cambionCycle: {
    active: "fass",
    timeLeft: "60m",
  ...
  invasions: [
    {
      ...
      attacker: {
        faction: "Grineer",
        reward: {
          countedItems: [{ count: 1, type: "Orokin Catalyst Blueprint" }],
        },
      },
      defender: {
        faction: "Corpus",
        reward: { countedItems: [{ count: 3, type: "Fieldron" }] },
      },
      completion: 45.5,
      eta: "5h 30m",
    },
...
describe("API Error Handling", () => {
  it("should provide fallback values for missing data", () => {
    ...
    expect(incompleteResponse.earthCycle || { isDay: false }).toHaveProperty(
      "isDay",
    );
