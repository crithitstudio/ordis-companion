    ...
    return (
        <div className="space-y-6">
            <div className="bg-slate-900/50 rounded-xl border border-purple-900/30 p-6">
                ...
                <p className="text-slate-400 mb-6">Track items you're crafting, farming, or working towards.</p>
                ...
                <div className="mb-6">
                    ...
                    {pendingItems.length === 0 ? (
                        <p className="text-slate-500 text-center py-4">No items being tracked. Add something above or from the Codex!</p>
                    ) : (
                        <div className="space-y-2">
                            {pendingItems.map(item => (
                                <div key={item.id} className="flex items-center justify-between bg-slate-800/30 rounded-lg p-4 border border-slate-700/50">
                    ...
                    <div>
                        ...
                        <div className="space-y-2">
                            {completedItems.map(item => (
                                <div key={item.id} className="flex items-center justify-between bg-green-900/10 rounded-lg p-4 border border-green-900/30">
                                    <div className="flex items-center gap-4">
                                        <button
                                            onClick={() => toggleComplete(item.id)}
                                        ...
                                        <div>
                                            <h4 className="text-slate-400 font-medium line-through">{item.name}</h4>
