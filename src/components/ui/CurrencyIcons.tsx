...
export function EndoIcon({
    ...
    return (
        ...
        >
            ...
            {/* Inner highlight */}
            <polygon points="12,5 15,8 15,14 12,17 9,14 9,8" fill="currentColor" opacity="0.4" />
        </svg>
    );
}
...
export function RegalAyaIcon({
    ...
    return (
        ...
        >
            ...
            {/* Inner glow */}
            <polygon points="12,10 14,14 10,14" fill="url(#regalAyaGrad)" opacity="0.5" />
        </svg>
    );
}
...
export function VitusEssenceIcon({
    ...
    return (
        ...
        >
            ...
            />
            {/* Inner facet */}
            <path d="M12 8l-3 2v4l3 2 3-2v-4l-3-2z" fill="currentColor" opacity="0.5" />
        </svg>
    );
}
