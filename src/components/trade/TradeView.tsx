...
export function TradeView() {
  ...
  const addTrade = useCallback(() => {
    ...
    addToast(
      `Trade recorded: ${trade.type === "sell" ? "+" : "-"}${trade.platinum}p`,
      "success",
    );
  ...
  const deleteTrade = useCallback(
    (id: string) => {
      ...
      const platChange =
        trade.type === "sell" ? -trade.platinum : trade.platinum;
  ...
  const stats = useMemo(() => {
    ...
    const totalSold = state.trades
      .filter((t) => t.type === "sell")
      .reduce((sum, t) => sum + t.platinum, 0);
    const totalBought = state.trades
      .filter((t) => t.type === "buy")
      .reduce((sum, t) => sum + t.platinum, 0);
    ...
    <div className="space-y-6">
      ...
      <section className="bg-gradient-to-r from-cyan-900/30 to-slate-900/50 rounded-xl border border-cyan-700/30 p-6">
            ...
            {editingBalance ? (
              <div className="flex items-center gap-2">
                <input
                  ...
                  value={tempBalance}
                  onChange={(e) =>
                    setTempBalance(parseInt(e.target.value) || 0)
                  }
              ...
              <button
                onClick={() => {
                  setTempBalance(state.platinumBalance);
              ...
              >
                ...
                <span className="text-3xl font-bold text-cyan-300">
                  {state.platinumBalance.toLocaleString()}
                </span>
              </button>
            )}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          ...
          <div className="bg-slate-800/50 rounded-lg p-3 text-center">
            ...
            <div
              className={`text-lg font-bold ${stats.tradesRemaining > 2 ? "text-green-400" : stats.tradesRemaining > 0 ? "text-yellow-400" : "text-red-400"}`}
            >
          ...
          <div className="bg-slate-800/50 rounded-lg p-3 text-center">
            ...
            <div
              className={`text-lg font-bold ${stats.profit >= 0 ? "text-green-400" : "text-red-400"}`}
            >
              {stats.profit >= 0 ? "+" : ""}
          ...
          <div className="space-y-2 max-h-96 overflow-y-auto">
            {state.trades.slice(0, 20).map((trade) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <span
                    className={`font-bold ${trade.type === "sell" ? "text-green-400" : "text-blue-400"}`}
                  >
                    {trade.type === "sell" ? "+" : "-"}
                    {trade.platinum}p
                  </span>
      ...
      <div className="bg-slate-800/30 border border-slate-700/50 rounded-lg p-4">
        ...
        <ul className="text-sm text-slate-400 space-y-1">
          ...
          <li>
            • Use <strong>warframe.market</strong> to check fair prices
          </li>
